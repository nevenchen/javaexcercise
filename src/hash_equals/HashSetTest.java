...
public class HashSetTest {
	...
	static void method1(){
		...
		/*实际上hashset中只添加进了一个“neven”，这是因为按照java判断对象是否相等的规则（set中不能有重复的对象，否则后面添加的将替代之前的）
		 * 1: hashcode相等，进入2
		 * 2：  equals()也相等，
		 * hashset会得出如下结论： s1,s2为同一对象； s2替代掉s1
		 * 
		 */
	...
	static void method2(){
		...
		System.out.println(std1.hashCode() == std2.hashCode());//false; 原因：Object.hashCode()比较的是对象的引用地址的hash值
		System.out.println();
